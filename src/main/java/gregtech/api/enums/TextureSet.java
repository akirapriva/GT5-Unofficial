...
public class TextureSet {
    ...
    private static final String[] SUFFIXES = new String[] { "/dustTiny", "/dustSmall", "/dust", "/dustImpure",
        ...
        "/toolHeadScrewdriver", "/toolHeadBuzzSaw", "/toolHeadSoldering", "/nanites", "/wireFine", "/gearGtSmall",
        "/rotor", "/stickLong", "/springSmall", "/spring", "/arrowGtWood", "/arrowGtPlastic", "/gemChipped",
        "/gemFlawed", "/gemFlawless", "/gemExquisite", "/gearGt", "/oreRaw", aTextVoidDir, aTextVoidDir, "/oreSmall",
        "/ore", "/wire", "/foil", "/block1", "/block2", "/block3", "/block4", "/block5", "/block6", "/pipeSide",
        "/pipeTiny", "/pipeSmall", "/pipeMedium", "/pipeLarge", "/pipeHuge", "/frameGt", "/pipeQuadruple",
        "/pipeNonuple", "/sheetmetal", aTextVoidDir, aTextVoidDir, aTextVoidDir, aTextVoidDir, aTextVoidDir,
        ...
        "/toolTurbine", "/toolWrench", "/toolCrowbar", "/toolWireCutter", "/toolScoop", "/toolBranchCutter",
        "/toolKnife", "/toolKnifeButchery", "/toolPlunger", "/toolJackHammer", "/pocketMultiToolClosed",
        "/pocketMultiToolKnife", "/pocketMultiToolSaw", "/pocketMultiToolFile", "/pocketMultiToolScrewdriver",
        "/pocketMultiToolWireCutter", "/pocketMultiToolBranchCutter", "/toolTrowel", "/toolHeadAngleGrinder",
        "/toolHeadElectricSnips", "/handleFile", "/handleTrowel", "/handleSaw", "/handleScrewdriver", "/toolHeadMallet",
        ...
        aTextVoidDir, aTextVoidDir, aTextVoidDir, aTextVoidDir, aTextVoidDir, aTextVoidDir, aTextVoidDir, aTextVoidDir,
        aTextVoidDir, aTextVoidDir, aTextVoidDir, aTextVoidDir, aTextVoidDir, aTextVoidDir, aTextVoidDir, aTextVoidDir,
        aTextVoidDir, aTextVoidDir, aTextVoidDir, aTextVoidDir, aTextVoidDir };
